...
ssh greatlakes '/usr/bin/env CANDIDATE_SUITE=/nfs/turbo/coe-chaijy-unreplicated/hongzefu/SimpleMemVLA/logs/robomme_sim/smvla-injection700-nodemo-20260918 CANDIDATE_LANE=hold01 /usr/bin/bash /nfs/turbo/coe-chaijy-unreplicated/hongzefu/SimpleMemVLA/scripts/gl_run_robomme.sh 61495429 smvla-injection700-nodemo-20260918-hold01' &
HOLD01_PID=$!
ssh greatlakes '/usr/bin/env CANDIDATE_SUITE=/nfs/turbo/coe-chaijy-unreplicated/hongzefu/SimpleMemVLA/logs/robomme_sim/smvla-injection700-nodemo-20260918 CANDIDATE_LANE=hold02 /usr/bin/bash /nfs/turbo/coe-chaijy-unreplicated/hongzefu/SimpleMemVLA/scripts/gl_run_robomme.sh 61495430 smvla-injection700-nodemo-20260918-hold02' &
HOLD02_PID=$!
CODE01=0
CODE02=0
